...
- Added optional `multiline` editor hints for top-level `string` fields and repeater item `string` fields.
- Added optional `minItems` and `maxItems` editor hints for `repeater` fields.
